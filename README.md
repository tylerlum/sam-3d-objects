...
Use Python 3.11 intentionally here. Python 3.12 did not work cleanly for this setup because the pinned `bpy==4.3.0` dependency was not compatible in the environment we used.
